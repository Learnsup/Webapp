...
// Add data
        chart.data = [
            {"sector": "Git push", "size": 6.8},
            {"sector": "Draw", "size": 12.8},
            {"sector": "Develop Web app", "size": 22.2},
            {"sector": "Do homework", "size": 2.2},
            {"sector": "Design mobile app UI", "size": 4.5},
            {"sector": "Develop mobile app", "size": 0},
            {"sector": "Learn Malbolge", "size": 15},
            {"sector": "Learn", "size": 34.6}];
...
// Animate chart data
        ...
        am4core.ready(function () {
            var chart = am4core.create("chartdivtimeline", am4plugins_timeline.CurveChart);
            ...
            chart.data = [{
                "category": "",
                "start": "2021-06-26 06:00",
                "end": "2021-06-26 06:15",
                "color": colorSet.getIndex(15),
                "icon": alarm,
                "text": "Wake up!"
            }, {
                "category": "",
                "start": "2021-06-26 06:15",
                "end": "2021-06-26 07:00",
                ...
                {
                    "category": "",
                    "start": "2021-06-26 07:00",
                    "end": "2021-06-26 08:00",
                ...
                {
                    "category": "",
                    "start": "2021-06-26 11:00",
                    "end": "2021-06-26 12:00",
                    "color": colorSet.getIndex(10),
                    "icon": dinner,
                    "text": "Lunch"
                },
                {
                    "category": "",
                    "start": "2021-06-26 12:00",
                    "end": "2021-06-26 13:30",
                    "color": colorSet.getIndex(10),
                    "icon": bed,
                    "text": "Noon break"
                },
                {
                    "category": "",
                    "start": "2021-06-26 13:30",
                    "end": "2021-06-26 17:00",
                ...
                {
                    "category": "",
                    "start": "2021-06-26 17:00",
                    "end": "2021-06-26 19:00",
                ...
                {
                    "category": "",
                    "start": "2021-06-26 19:00",
                    "end": "2021-06-26 20:00",
                    "color": colorSet.getIndex(7),
                    "icon": dinner,
                    "text": "Dinner"
                },
                ...
                {
                    "category": "",
                    "start": "2021-06-26 21:30",
                    "end": "2021-06-27 06:30",
                ...
                {
                    "category": "",
                    "start": "2021-06-27 06:30",
                    "end": "2021-06-26 06:45",
            ...
            dateAxis.min = new Date(2021, 5, 25, 25, 40).getTime();
            dateAxis.max = new Date(2021, 5, 27, 5, 30).getTime();
...
// Themes end
        ...
        lineSeries.dataFields.valueY = "efficiency";
        lineSeries.tooltipText = "efficiency: {valueY.value}"   ;
...
// Create chart instance
        var chart = am4core.create("chartdivcolumn", am4charts.XYChart);
        chart.scrollbarX = new am4core.Scrollbar();
        chart.scrollbarX.parent = chart.bottomAxesContainer;
...
// Themes end
        ...
        var chart = am4core.create("chartdivgnatt", am4charts.XYChart);
...
<!-- HTML -->
<!-- HTML -->
<div id="chartdivtimeline"></div>
<div id="chartdivdonut"></div>
<div id="chartdivline"></div>
<div id="chartdivcolumn"></div>
<div id="chartdivgnatt"></div>
